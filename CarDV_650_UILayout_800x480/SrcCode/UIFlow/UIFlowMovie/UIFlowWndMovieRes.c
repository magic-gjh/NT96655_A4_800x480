...
SHOW_ITEM_GROUP(CMD_Group,Normal2,12,9,59,56)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_camera,0,12,9,59,56)
...
SHOW_ITEM_GROUP(CMD_Group,Normal6,13,91,60,138)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_CyclicRec,0,13,91,60,138)
...
SHOW_ITEM_GROUP(CMD_Group,Normal13,18,156,65,203)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_MotionDet,0,18,156,65,203)
...
SHOW_ITEM_GROUP(CMD_Group,Normal18,751,447,798,488)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_battery,0,751,447,798,488)
...
SHOW_ITEM_GROUP(CMD_Group,Normal28,262,433,411,480)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_YMD_Static,0,262,433,411,480)
...
SHOW_ITEM_GROUP(CMD_Group,Normal33,411,434,560,481)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_HMS_Static,0,411,434,560,481)
...
SHOW_ITEM_GROUP(CMD_Group,Normal38,756,403,803,450)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_Storage,0,756,403,803,450)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text47,0,0,117,47,STRID_NULL,0,1280,0,0,2,1,0,0,0,18,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal54,652,42,851,89)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_resolution,0,652,42,851,89)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin65Rect,0,0,47,42,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin65)
SHOW_MAP_BODY(Skin65Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin65,0,0,47,42)
...
SHOW_ITEM_GROUP(CMD_Group,Normal64,16,239,63,281)
...
CREATE_STATE_CTRL(UIFlowWndMovie_StatusICN_EV,0,16,239,63,281)
...
SHOW_ITEM_GROUP(CMD_Group,Normal80,156,9,203,56)

CREATE_STATE_ITEM_DATA(ICONID_NULL83,STRID_NULL,ICONID_NULL,NULL) 
CREATE_STATE_ITEM_DATA(ICON_WDR84,STRID_NULL,ICON_WDR,NULL) 
...
STATE_LIST_ITEM(ICON_WDR84)
STATE_LIST_END

CREATE_STATE_DATA(UIFlowWndMovie_Status_HDR,0)
CREATE_STATE_CTRL(UIFlowWndMovie_Status_HDR,0,156,9,203,56)
...
SHOW_ITEM_GROUP(CMD_Group,Normal110,59,450,106,497)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_Lock,0,59,450,106,497)
...
SHOW_ITEM_GROUP(CMD_Group,Normal114,5,439,52,486)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_Audio,0,5,439,52,486)
...
SHOW_ITEM_GROUP(CMD_Group,Normal124,1,177,48,224)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_TimeLapes,0,1,177,48,224)
...
SHOW_ITEM_GROUP(CMD_Group,Normal129,738,97,785,144)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_ParkingMonitor,0,738,97,785,144)
...
SHOW_ITEM_GROUP(CMD_Group,Normal134,352,0,491,47)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_CarNo_Static,0,352,0,491,47)
...
SHOW_ITEM_GROUP(CMD_Group,Normal139,312,1,351,48)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_ZHCarNo,0,312,1,351,48)
...
SHOW_ITEM_GROUP(CMD_Group,Normal175,0,233,799,479)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_Guide,0,0,233,799,479)
