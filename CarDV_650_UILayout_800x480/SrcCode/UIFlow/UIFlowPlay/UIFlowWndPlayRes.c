...
SHOW_ITEM_RECT(CMD_Rectangle,Skin3Rect,0,0,47,47,0,0,0,0,0,0,0)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon4, 0, 0, 47,47, ICONID_NULL,0,0,0,0,0,0,0,0)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_DSCMode,0,12,5,59,52)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon8, 0, 0, 47,47, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal6)
SHOW_MAP_BODY(Skin7)
SHOW_MAP_BODY(Icon8)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal6,12,174,59,221)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Flash,0,12,174,59,221)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon15, 0, 0, 47,47, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal13)
SHOW_MAP_BODY(Skin14)
SHOW_MAP_BODY(Icon15)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal13,12,60,59,107)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_EV,0,12,60,59,107)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin30Rect,0,0,149,35,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin30)
SHOW_MAP_BODY(Skin30Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin30,0,0,149,35)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text32,0,0,149,35,STRID_NULL,0,1280,0,0,2,1,0,0,0,18,0,0,0,0)
SHOW_MAP_BEGIN(Normal29)
SHOW_MAP_BODY(Skin30)
SHOW_MAP_BODY(Text32)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal29,638,52,787,87)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Size,0,638,52,787,87)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin35Rect,0,0,47,47,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin35)
SHOW_MAP_BODY(Skin35Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin35,0,0,47,47)
...
SHOW_ITEM_GROUP(CMD_Group,Normal34,12,119,59,166)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_WB,0,12,119,59,166)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin43Rect,0,0,47,47,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin43)
SHOW_MAP_BODY(Skin43Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin43,0,0,47,47)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon44, 0, 0, 47,47, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal42)
SHOW_MAP_BODY(Skin43)
SHOW_MAP_BODY(Icon44)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal42,738,260,785,307)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Quality,0,738,260,785,307)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin49Rect,0,0,47,47,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin49)
SHOW_MAP_BODY(Skin49Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin49,0,0,47,47)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon50, 0, 0, 47,47, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal48)
SHOW_MAP_BODY(Skin49)
SHOW_MAP_BODY(Icon50)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal48,738,315,785,362)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Sharpness,0,738,315,785,362)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin55Rect,0,0,47,47,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin55)
SHOW_MAP_BODY(Skin55Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin55,0,0,47,47)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon56, 0, 0, 47,47, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal54)
SHOW_MAP_BODY(Skin55)
SHOW_MAP_BODY(Icon56)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal54,738,370,785,417)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Storage,0,738,370,785,417)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin60Rect,0,0,47,41,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin60)
SHOW_MAP_BODY(Skin60Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin60,0,0,47,41)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon61, 0, 0, 47,41, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal59)
SHOW_MAP_BODY(Skin60)
SHOW_MAP_BODY(Icon61)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal59,738,431,785,472)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Battery,0,738,431,785,472)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin71Rect,0,0,179,35,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin71)
SHOW_MAP_BODY(Skin71Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin71,0,0,179,35)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text73,0,0,179,35,STRID_NULL,0,1280,0,0,2,1,1,0,0,18,0,0,0,0)
SHOW_MAP_BEGIN(Normal70)
SHOW_MAP_BODY(Skin71)
SHOW_MAP_BODY(Text73)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal70,608,14,787,49)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Filename,0,608,14,787,49)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin76Rect,0,0,47,47,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin76)
SHOW_MAP_BODY(Skin76Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin76,0,0,47,47)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon77, 0, 0, 47,47, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal75)
SHOW_MAP_BODY(Skin76)
SHOW_MAP_BODY(Icon77)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal75,67,5,114,52)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_Protect,0,67,5,114,52)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin80Rect,0,0,149,35,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin80)
SHOW_MAP_BODY(Skin80Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin80,0,0,149,35)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text82,0,0,149,35,STRID_NULL,0,1280,0,0,2,1,1,0,0,18,0,0,0,0)
SHOW_MAP_BEGIN(Normal79)
SHOW_MAP_BODY(Skin80)
SHOW_MAP_BODY(Text82)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal79,250,432,399,467)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Date,0,250,432,399,467)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin85Rect,0,0,149,35,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin85)
SHOW_MAP_BODY(Skin85Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin85,0,0,149,35)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text87,0,0,149,35,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal84)
SHOW_MAP_BODY(Skin85)
SHOW_MAP_BODY(Text87)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal84,420,432,569,467)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Time,0,420,432,569,467)
...
SHOW_ITEM_GROUP(CMD_Group,Normal90,12,440,65,467)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovPlay,0,12,440,65,467)
...
SHOW_ITEM_GROUP(CMD_Group,Normal95,130,440,183,467)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovStop,0,130,440,183,467)
...
SHOW_ITEM_GROUP(CMD_Group,Normal99,240,440,293,467)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovBwd,0,240,440,293,467)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin104Rect,0,0,149,35,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin104)
SHOW_MAP_BODY(Skin104Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin104,0,0,149,35)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text106,30,0,179,35,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal103)
SHOW_MAP_BODY(Skin104)
SHOW_MAP_BODY(Text106)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal103,670,52,819,87)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovPlayTime,0,670,52,819,87)
...
SHOW_ITEM_GROUP(CMD_Group,Normal108,360,440,413,467)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovFwd,0,360,440,413,467)
...
SHOW_ITEM_GROUP(CMD_Group,Normal112,131,403,242,430)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Volumn,0,131,403,242,430)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon126, 0, 0, 47,47, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal124)
SHOW_MAP_BODY(Skin125)
SHOW_MAP_BODY(Icon126)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal124,12,229,59,276)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_Print,0,12,229,59,276)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin129Rect,0,0,59,35,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin129)
SHOW_MAP_BODY(Skin129Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin129,0,0,59,35)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text131,0,0,59,35,STRID_NULL,0,1280,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal128)
SHOW_MAP_BODY(Skin129)
SHOW_MAP_BODY(Text131)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal128,30,394,89,429)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Speed,0,30,394,89,429)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin134Rect,0,0,149,35,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin134)
SHOW_MAP_BODY(Skin134Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin134,0,0,149,35)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text136,0,0,149,35,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal133)
SHOW_MAP_BODY(Skin134)
SHOW_MAP_BODY(Text136)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal133,120,14,269,49)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovTotalTime,0,120,14,269,49)
