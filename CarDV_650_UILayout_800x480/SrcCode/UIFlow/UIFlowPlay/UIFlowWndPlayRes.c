...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text106,0,0,149,35,STRID_NULL,0,1280,0,0,3,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal103)
SHOW_MAP_BODY(Skin104)
SHOW_MAP_BODY(Text106)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal103,120,14,269,49)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovPlayTime,0,120,14,269,49)
