...
SHOW_ITEM_GROUP(CMD_Group,Skin5,0,0,449,47)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text7,0,0,449,47,STRID_NULL,0,0,0,0,2,0,0,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal4)
SHOW_MAP_BODY(Skin5)
SHOW_MAP_BODY(Text7)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal4,290,197,739,244)
...
CREATE_STATIC_CTRL(UIMenuSetupVersionText,0,290,197,739,244)
...
SHOW_ITEM_GROUP(CMD_Group,Skin10,0,0,449,47)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text12,0,0,449,47,STRID_NULL,0,0,0,0,2,0,0,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal9)
SHOW_MAP_BODY(Skin10)
SHOW_MAP_BODY(Text12)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal9,290,260,739,307)
...
CREATE_STATIC_CTRL(UIMenuSetupVersionText2,0,290,260,739,307)
