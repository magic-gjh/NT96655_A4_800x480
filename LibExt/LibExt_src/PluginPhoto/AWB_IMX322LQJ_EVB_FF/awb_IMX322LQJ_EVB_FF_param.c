...
AWBALG_ELEMET WhiteOutdoorElement[] =
{
    ...
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
		...
		AWBALG_ELEMET WhiteIndoorElement[] =
		{
		    ...
		    {AWBALG_TYPE_BG,     408, 142, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RBG,    414,  80, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RBGSUM, 489, 302, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RXBG,   476, 252, {  0,  0}, {  0,  0}},
		    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
		};
		...
		AWBALG_ELEMET WhiteOutdoorElement[] =
		{
		    ...
		    {AWBALG_TYPE_BG,     389, 142, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RBG,    136,  80, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RBGSUM, 478, 302, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RXBG,   476, 252, {  0,  0}, {  0,  0}},
		    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
		};
	#else  //F2.0
		...
		AWBALG_ELEMET WhiteIndoorElement[] =
		{
		    ...
		    {AWBALG_TYPE_RG,     223,  84, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_BG,     462, 138, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RBG,    434,  75, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RBGSUM, 607, 276, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RXBG,   588, 224, {  0,  0}, {  0,  0}},
		    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
		};
		...
		{
		    {AWBALG_TYPE_Y,      (200<<4),   (6<<4), {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RG,     223, 108, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_BG,     385, 138, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RBG,    240,  75, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RBGSUM, 579, 276, {  0,  0}, {  0,  0}},
		    {AWBALG_TYPE_RXBG,   588, 224, {  0,  0}, {  0,  0}},
		    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
		};
