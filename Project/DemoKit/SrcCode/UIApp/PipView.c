...
static URECT m_PipWnd_Small[PIP_DST_RATIO_MAX_CNT][PIP_SRC_RATIO_MAX_CNT] = {
    ...
    {{80,0,240,180},{0,0,320,180},{323,178,320,180}},
};
#else
static URECT m_PipWnd_Small[PIP_DST_RATIO_MAX_CNT][PIP_SRC_RATIO_MAX_CNT] = {
    {{0,0,320,240},{0,60,320,180},{0,27,320,212}},
    {{80,0,240,180},{0,0,320,180},{330,180,320,180}},
};
#endif
#if 0
static URECT m_PipWnd_Small[PIP_DST_RATIO_MAX_CNT][PIP_SRC_RATIO_MAX_CNT] = {
...
#endif
PIP_STYLE PipView_GetStyle(void)
{
	return m_PipStyle;
}
...
INT32 PipView_OnDraw(DISPSRV_DRAW* pDraw) //PIP = Picture In Picture
{
    ...
    if(DrvSensor_Det2ndSensor())
    {
    	...
    	{
	    #if 1//((_LCDTYPE_ == _LCDTYPE_HX8369B_DSI_)||(_LCDTYPE_ == _LCDTYPE_UT45030A0_HX8379C_)||(_LCDTYPE_ == _LCDTYPE_TM446_OTM8019A_)\
			//||(_LCDTYPE_ == _LCDTYPE_UT45030A0_HX8379C_JIUJIUYI_))
	    {
