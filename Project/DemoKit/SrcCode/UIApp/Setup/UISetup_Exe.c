...
INT32 SetupExe_OnLanguage(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    if((UI_GetData(FL_LANGUAGE)!=LANG_SC)&&(SysGetFlag(FL_LANGUAGE) == LANG_TC))
    {
...
INT32 SetupExe_OnLCDOff(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    switch(uhSelect)
    {
        ...
        case LCDOFF_3SEC:
            ...
            GxCustom_SetControl(GXCUSTOM_CTRL_AUTOLCDOFF_TIME, 3);
        break;				
        case LCDOFF_30SEC:
            GxCustom_SetControl(GXCUSTOM_CTRL_AUTOLCDOFF_EN, TRUE);
        ...
        case LCDOFF_30SEC:
            GxCustom_SetControl(GXCUSTOM_CTRL_AUTOLCDOFF_EN, TRUE);
            GxCustom_SetControl(GXCUSTOM_CTRL_AUTOLCDOFF_TIME, 180);
        break;
        case LCDOFF_1MIN:
            GxCustom_SetControl(GXCUSTOM_CTRL_AUTOLCDOFF_EN, TRUE);
            GxCustom_SetControl(GXCUSTOM_CTRL_AUTOLCDOFF_TIME, 300);
        break;
        case LCDOFF_2MIN:
            GxCustom_SetControl(GXCUSTOM_CTRL_AUTOLCDOFF_EN, TRUE);
            GxCustom_SetControl(GXCUSTOM_CTRL_AUTOLCDOFF_TIME, 600);
        break;	
#endif		
#endif
        default:
...
INT32 SetupExe_OnDelayOff(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    switch(uhSelect)
    {
        ...
        case DELAYOFF_10SEC:
            ...
            GxCustom_SetControl(GXCUSTOM_CTRL_DELAYOFF_TIME, 15);
        break;
        case DELAYOFF_20SEC:
            debug_msg("DELAYOFF_10SEC================1\r\n");
            GxCustom_SetControl(GXCUSTOM_CTRL_DELAYOFF_EN, TRUE);
            GxCustom_SetControl(GXCUSTOM_CTRL_DELAYOFF_TIME, 60);
        break;
        case DELAYOFF_30SEC:
