...
SHOW_ITEM_GROUP(CMD_Group,Normal6,12,59,39,86)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_CyclicRec,0,12,59,39,86)
...
SHOW_ITEM_GROUP(CMD_Group,Normal13,12,96,39,123)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_MotionDet,0,12,96,39,123)
...
SHOW_ITEM_GROUP(CMD_Group,Normal18,442,246,475,273)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_battery,0,442,246,475,273)
...
SHOW_ITEM_GROUP(CMD_Group,Normal28,142,250,262,270)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_YMD_Static,0,142,250,262,270)
...
SHOW_ITEM_GROUP(CMD_Group,Normal33,276,248,362,268)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_HMS_Static,0,276,248,362,268)
...
SHOW_ITEM_GROUP(CMD_Group,Normal38,444,212,471,239)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_Storage,0,444,212,471,239)
...
SHOW_ITEM_GROUP(CMD_Group,Normal44,395,0,480,29)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_time,0,395,0,480,29)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text52,0,-1,85,28,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal49)
SHOW_MAP_BODY(Skin50)
SHOW_MAP_BODY(Text52)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal49,395,1,480,30)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_maxtime,0,395,1,480,30)
...
SHOW_ITEM_GROUP(CMD_Group,Normal54,365,28,472,57)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_resolution,0,365,28,472,57)
...
SHOW_ITEM_GROUP(CMD_Group,Normal59,186,202,229,221)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Zoom_Static,0,186,202,229,221)
...
SHOW_ITEM_GROUP(CMD_Group,Normal89,445,72,472,99)
...
SHOW_ITEM_GROUP(CMD_Group,Normal94,445,171,472,198)
...
SHOW_ITEM_GROUP(CMD_Group,Normal99,445,138,472,165)
...
SHOW_ITEM_GROUP(CMD_Group,Normal106,146,5,173,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal110,4,243,31,270)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_Audio,0,4,243,31,270)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon117, 0, 0, 27,27, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_MAP_BEGIN(Normal115)
SHOW_MAP_BODY(Skin116)
SHOW_MAP_BODY(Icon117)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal115,46,5,73,32)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin121Rect,0,0,27,27,0,0,0,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal120,11,106,38,133)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_TimeLapes,0,11,106,38,133)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin126Rect,0,0,27,27,0,0,0,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal125,445,105,472,132)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin131Rect,0,0,149,19,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin131)
SHOW_MAP_BODY(Skin131Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin131,0,0,149,19)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text133,0,0,149,19,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal130)
SHOW_MAP_BODY(Skin131)
SHOW_MAP_BODY(Text133)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal130,241,6,390,25)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_CarNo_Static,0,241,6,390,25)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin136Rect,0,0,20,24,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin136)
SHOW_MAP_BODY(Skin136Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin136,0,0,20,24)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text138,0,0,20,24,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal135)
SHOW_MAP_BODY(Skin136)
SHOW_MAP_BODY(Text138)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal135,214,6,234,30)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_ZHCarNo,0,214,6,234,30)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin172Rect,0,0,319,112,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin172)
SHOW_MAP_BODY(Skin172Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin172,0,0,319,112)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon173, 0, 0, 27,27, ICONID_NULL,83886080,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal171)
SHOW_MAP_BODY(Skin172)
SHOW_MAP_BODY(Icon173)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal171,80,110,399,222)
