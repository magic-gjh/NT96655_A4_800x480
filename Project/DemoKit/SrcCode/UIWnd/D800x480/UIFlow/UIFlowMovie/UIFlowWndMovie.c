...
extern void DetBatteryLowToPowerOff(void);
// Movie mode key mask
...
#if ((_MODEL_DSC_ == _MODEL_DUAL_V18_DT_)||(_MODEL_DSC_ == _MODEL_CARDV_GT200_)||(_MODEL_DSC_ == _MODEL_DUAL_V18_LYSZ_))	 
        case MOV_ST_REC:
        case MOV_ST_REC|MOV_ST_ZOOM:
		    uiSelect=  UI_GetData(FL_MOVIE_AUDIO);
...
#elif((_MODEL_DSC_ == _MODEL_DUAL_F6PLUS_)||(_MODEL_DSC_ == _MODEL_DUAL_V18_DT_)||(_MODEL_DSC_ == _MODEL_DUAL_HLYD_)\
