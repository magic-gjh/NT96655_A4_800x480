...
EVENT_ITEM(NVTEVT_KEY_CUSTOM1,UIFlowWndPlay_OnKeyShutter2)
#elif(_MODEL_DSC_== _MODEL_DUAL_NAZHIDA_)
EVENT_ITEM(NVTEVT_KEY_CUSTOM1,UIFlowWndPlay_OnKeyShutter2)
#else
EVENT_ITEM(NVTEVT_KEY_CUSTOM1,UIFlowWndPlay_OnKeyCustome1)
...
//#NT#2012/08/31#Calvin Chang -end
INT32 UIFlowWndPlay_OnKeyCustome1(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32  uiKeyAct;
