...
void app_set_playthumb_to_play(void)
{
	PlayThumbToPlay = 1;
}

void app_reset_playthumb_to_play(void)
{
	PlayThumbToPlay = 0;
}
extern PURECT FlowPB_ThumbDisplay(UINT32 Thumbdevice,USIZE size);
...
URECT   FlowPBThumbRect01[FLOWPB_THUMB_H_NUM2*FLOWPB_THUMB_V_NUM2];
URECT   FlowPBThumbRect02[FLOWPB_THUMB_H_NUM2*FLOWPB_THUMB_V_NUM2];
INT32 UIFlowWndPlayThumb_OnOpen(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    // get LCD1/HDMI/TV thumbnail rect
    size.w = CfgDisp.Desc[DISPSRV_DISP_IDX_PRIMARY].pDisp[0].Width;
    size.h = CfgDisp.Desc[DISPSRV_DISP_IDX_PRIMARY].pDisp[0].Height;
    pThumbRect = FlowPB_ThumbDisplay(PLB_THUMB_FULL,size);
    memcpy(&FlowPBThumbRect01[0],pThumbRect,sizeof(FlowPBThumbRect01));
    #elif (DUALDISP_FUNC == DUALDISP_ONXOR)
    // get LCD1 thumbnail rect
    size.w = CfgDisp.Desc[DISPSRV_DISP_IDX_PRIMARY].pDisp[0].Width;
    size.h = CfgDisp.Desc[DISPSRV_DISP_IDX_PRIMARY].pDisp[0].Height;
    pThumbRect = FlowPB_ThumbDisplay(PLB_THUMB_LCD,size);
    memcpy(&FlowPBThumbRect01[0],pThumbRect,sizeof(FlowPBThumbRect01));
    // get LCD2 thumbnail rect
    size.w = CfgDisp.Desc[DISPSRV_DISP_IDX_SECONDARY].pDisp[0].Width;
    size.h = CfgDisp.Desc[DISPSRV_DISP_IDX_SECONDARY].pDisp[0].Height;
    pThumbRect = FlowPB_ThumbDisplay(PLB_THUMB_LCD,size);
    memcpy(&FlowPBThumbRect02[0],pThumbRect,sizeof(FlowPBThumbRect02));
    #else
    // get LCD1 thumbnail rect
    size.w = CfgDisp.Desc[DISPSRV_DISP_IDX_PRIMARY].pDisp[0].Width;
    size.h = CfgDisp.Desc[DISPSRV_DISP_IDX_PRIMARY].pDisp[0].Height;
    pThumbRect = FlowPB_ThumbDisplay(PLB_THUMB_LCD,size);
    memcpy(&FlowPBThumbRect01[0],pThumbRect,sizeof(FlowPBThumbRect01));
    // get HDMI/TV thumbnail rect
    size.w = CfgDisp.Desc[DISPSRV_DISP_IDX_SECONDARY].pDisp[0].Width;
    size.h = CfgDisp.Desc[DISPSRV_DISP_IDX_SECONDARY].pDisp[0].Height;
    pThumbRect = FlowPB_ThumbDisplay(PLB_THUMB_HDMITV,size);
    memcpy(&FlowPBThumbRect02[0],pThumbRect,sizeof(FlowPBThumbRect02));
    #endif
    ...
    BrowseInitObj.pThumbRect = &FlowPBThumbRect01[0];
    #if (DUALDISP_FUNC != DUALDISP_OFF)
    BrowseInitObj.pThumbRect2 = &FlowPBThumbRect02[0];
    #endif
