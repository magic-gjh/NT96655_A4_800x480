...
enum _MENU_ID
{
    ...
    IDM_QUICK_REVIEW, // 12
    IDM_DATE_STAMP,  // 13
    IDM_LOW_POWER_TIMELAPSE_REC,  // 14
    IDM_TIMELAPSE_REC_MERGEYUV, // 15

    // Movie Page
    IDM_MOVIE_SIZE, // 16
    IDM_MOVIE_SIZE_DUAL,  // 17
    IDM_MOVIE_DUAL_REC, // 18
    IDM_MOVIE_CYCLIC_REC, // 19
    IDM_MOVIE_TIMELAPSE_REC,  // 20
    IDM_MOVIE_HDR,  // 21
    IDM_MOVIE_EV,  // 22
    IDM_MOVIE_MOTION_DET,  // 23
    IDM_MOVIE_AUDIO,  // 24
    IDM_MOVIE_DATEIMPRINT, // 25
    IDM_MOVIE_QUALITY,  // 26
    IDM_MOVIE_WB,  // 27
    IDM_MOVIE_COLOR,  // 28
    IDM_MOVIE_GSENSOR,  // 29
    IDM_MOVIE_GPS,  // 30
    IDM_MOVIE_PARKING,  // 31
    // Playback Page
    IDM_DELETE,  // 32
    IDM_PROTECT,  // 33 
    IDM_ROTATE, // 34
...
enum _MENU_IDS
{
    ...
    IDS_MOVIE_CYCLIC_REC_3MIN   = STRID_1MIN,
    IDS_MOVIE_CYCLIC_REC_5MIN   = STRID_3MIN,
    IDS_MOVIE_CYCLIC_REC_10MIN  = STRID_5MIN,
    ...
    // LED Setting  Options
    IDS_LEDSET_OFF   = STRID_OFF,
    IDS_LEDSET_ON    = STRID_ON,
    IDS_LEDSET_WARNING    = STRID_IRLED_WARNING,

    // LCD Setting  Options
    IDS_LCDOFF_OFF          = STRID_OFF,
    IDS_LCDOFF_3SEC        = STRID_3SEC,    
    IDS_LCDOFF_30SEC        = STRID_3MIN,
    IDS_LCDOFF_1MIN         = STRID_5MIN,
    IDS_LCDOFF_2MIN         = STRID_10MIN,
    
    // Opening Delay Off Options
    IDS_DELAYOFF_OFF        = STRID_OFF,
    IDS_DELAYOFF_10SEC       = STRID_15SEC,
    IDS_DELAYOFF_20SEC       = STRID_1MIN,    
    IDS_DELAYOFF_30SEC       = STRID_3MIN,
