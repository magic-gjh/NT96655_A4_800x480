...
#define DATETIME_DEFAULT_YEAR   2015//2012
...
static void UIMenuWndSetupDateTime_UpdateInfo(void)
{
    ...
    Ux_RECT rect1_1_1 = { 320-DATETIME_START_X,  103-DATETIME_START_Y, 387-DATETIME_START_X, 194-DATETIME_START_Y};
    Ux_RECT rect1_1_2 = {348-DATETIME_START_X,  103-DATETIME_START_Y, 163-DATETIME_START_X, 117-DATETIME_START_Y};
    Ux_RECT rect1_2   = {409-DATETIME_START_X,  103-DATETIME_START_Y, 448-DATETIME_START_X, 194-DATETIME_START_Y};
...
EVENT_ITEM(NVTEVT_KEY_CUSTOM1,UIMenuWndSetupDateTime_Tab_OnKeyShutter2)
#else
