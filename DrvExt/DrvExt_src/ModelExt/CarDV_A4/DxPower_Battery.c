...
// V = ADC*4.2/910
#define VOLDET_BATTERY_420V         858//860
#define VOLDET_BATTERY_400V         840//860
#define VOLDET_BATTERY_390V         820//795
#define VOLDET_BATTERY_385V         815//771
#define VOLDET_BATTERY_380V         805//771
#define VOLDET_BATTERY_370V         783//771
...
static UINT32 DrvPower_GetBatteryLevel(void)
{
	...
	static UINT32   uiGetBatteryCount = 0;
    BOOL            isMatch = FALSE;
    ...
    // Rising
    //debug_msg("uiCurBatteryADC = %d\r\n",uiCurBatteryADC);
	if(uiGetBatteryCount == 0)
	{
		uiGetBatteryCount = 1;
		
		if(uiCurBatteryADC < 762)
		{
			rtc_poweroffPWR();
		}
	}
